...
import io.provenance.scope.contract.annotations.processor.P8eAnnotations.PARTICIPANT
import io.provenance.scope.contract.spec.P8eContract

@SupportedAnnotationTypes("io.provenance.scope.contract.annotations.*")
...
open class ContractProcessor: AbstractProcessor() {
    ...
    override fun getSupportedAnnotationTypes(): MutableSet<String> {
        return mutableSetOf("io.provenance.scope.contract.annotations.*")
    }
