package io.provenance.scope.encryption.domain.inputstream
...
import io.provenance.scope.encryption.util.ByteUtil.writeUInt32
import io.provenance.scope.encryption.util.HashingCipherInputStream
import io.provenance.scope.encryption.domain.Signature
...
class DIMEInputStream(
    ...
    val sha256Internal: Boolean = true,
