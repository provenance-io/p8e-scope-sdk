...
class ValueOwnerException(message: String) : RuntimeException(message)
class EnvelopeAlreadySignedException(message: String): RuntimeException(message)
class OSException(message: String): RuntimeException(message)
